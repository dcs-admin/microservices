...
type CustomerServiceClient interface {
	...
	GetCustomers(ctx context.Context, in *CustomerListRequest, opts ...grpc.CallOption) (*CustomerListResponse, error)
}
...
func (c *customerServiceClient) GetCustomers(ctx context.Context, in *CustomerListRequest, opts ...grpc.CallOption) (*CustomerListResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type CustomerServiceServer interface {
	...
	GetCustomers(context.Context, *CustomerListRequest) (*CustomerListResponse, error)
...
func (UnimplementedCustomerServiceServer) GetCustomers(context.Context, *CustomerListRequest) (*CustomerListResponse, error) {
...
func _CustomerService_GetCustomers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CustomerServiceServer).GetCustomers(ctx, req.(*CustomerListRequest))
	}
	return interceptor(ctx, in, info, handler)
}
