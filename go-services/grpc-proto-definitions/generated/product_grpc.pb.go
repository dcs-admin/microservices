...
type ProductServiceClient interface {
	...
	GetProducts(ctx context.Context, in *ProductListRequest, opts ...grpc.CallOption) (*ProductListResponse, error)
}
...
func (c *productServiceClient) GetProducts(ctx context.Context, in *ProductListRequest, opts ...grpc.CallOption) (*ProductListResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type ProductServiceServer interface {
	...
	GetProducts(context.Context, *ProductListRequest) (*ProductListResponse, error)
...
func (UnimplementedProductServiceServer) GetProducts(context.Context, *ProductListRequest) (*ProductListResponse, error) {
...
func _ProductService_GetProducts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductServiceServer).GetProducts(ctx, req.(*ProductListRequest))
	}
	return interceptor(ctx, in, info, handler)
}
