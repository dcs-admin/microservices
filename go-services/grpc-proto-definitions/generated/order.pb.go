...
func (x *OrderResponse) GetCustomerId() uint64 {
	if x != nil {
		return x.CustomerId
	}
	return 0
...
func (x *OrderResponse) GetProductId() uint64 {
	if x != nil {
		return x.ProductId
	}
	return 0
...
func (x *OrderResponse) GetQuantity() uint32 {
	if x != nil {
		return x.Quantity
	}
	return 0
...
func (x *OrderResponse) GetTotalCost() float64 {
	if x != nil {
		return x.TotalCost
	}
	return 0
...
var file_order_proto_rawDesc = string([]byte{
	...
	0x52, 0x02, 0x69, 0x64, 0x22, 0xb2, 0x01, 0x0a, 0x0d, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x52, 0x65,
	...
	0x74, 0x79, 0x12, 0x1d, 0x0a, 0x0a, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x5f, 0x63, 0x6f, 0x73, 0x74,
	...
	0x09, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x32, 0x45, 0x0a, 0x0c, 0x4f, 0x72, 0x64,
	...
	0x6f, 0x75, 0x72, 0x2d, 0x6f, 0x72, 0x67, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2d, 0x64, 0x65,
	0x66, 0x69, 0x6e, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x2f, 0x67, 0x65, 0x6e, 0x65, 0x72, 0x61,
	0x74, 0x65, 0x64, 0x2f, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
})
